...
<https://docs.corda.net/_static/corda-technical-whitepaper.pdf>`_.  It defines a general platform for decentralised application development.  The paper described the concept of "CorDapps" (Corda Distributed Applications) and how these might be constructed, but did not attempt to provide much more detail.
...
Superficially, our problem is not particularly new.  There are many examples, predating any sort of blockchain or
DLT (Distributed Ledger) technology, of companies and consortiums that have brought people together to transact value.
The blockchain vision enabled by Corda is different, however, because it was designed to eliminate many of the
