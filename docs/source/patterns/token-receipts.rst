...
The receipts pattern can be extend so that the Chain state is an asset/ Cash. The receipts can then be used to evidence payment in another transaction which allows some other event to occur, eg movement of another asset.
