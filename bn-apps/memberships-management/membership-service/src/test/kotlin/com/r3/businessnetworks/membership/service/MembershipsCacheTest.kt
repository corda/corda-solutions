package com.r3.businessnetworks.membership.service

import com.r3.businessnetworks.membership.member.service.MembershipsCache
...
class MembershipsCacheTest {
    ...
    private fun membershipStateFor(bno : Party, member : Party) =  MembershipState(member, bno, SimpleMembershipMetadata(), Instant.now(), Instant.now(), MembershipStatus.PENDING)
