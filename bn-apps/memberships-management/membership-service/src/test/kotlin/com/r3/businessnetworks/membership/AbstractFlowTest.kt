...
import com.r3.businessnetworks.membership.bno.ActivateMembershipForPartyFlow
import com.r3.businessnetworks.membership.bno.NotifyMemberFlow
import com.r3.businessnetworks.membership.bno.SuspendMembershipFlow
import com.r3.businessnetworks.membership.bno.SuspendMembershipForPartyFlow
...
abstract class AbstractFlowTest(private val numberOfBusinessNetworks : Int,
    ...
    @Before
    open fun setup() {
        mockNetwork = MockNetwork(cordappPackages = listOf("com.r3.businessnetworks.membership",
