...
open class RequestMembershipFlow(bno : Party, private val membershipMetadata : Any, val JoiningNetworkID : String) : BusinessNetworkAwareInitiatingFlow<SignedTransaction>(bno) {
    companion object {
