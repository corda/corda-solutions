package com.r3.businessnetworks.cordaupdates.states
...
class ScheduledSyncContract : Contract {
    companion object {
        const val CONTRACT_NAME = "com.r3.businessnetworks.cordaupdates.states.ScheduledSyncContract"
    }
...
data class ScheduledSyncState(val syncInterval : Long,
    ...
    override fun nextScheduledActivity(thisStateRef : StateRef, flowLogicRefFactory : FlowLogicRefFactory)
            = ScheduledActivity(flowLogicRefFactory.create("com.r3.businessnetworks.cordaupdates.app.member.SyncArtifactsFlow", thisStateRef), Instant.now().plusMillis(syncInterval))
}