...
import net.corda.businessnetworks.cordaupdates.app.bno.GetCordappVersionsForPartyFlow
import net.corda.businessnetworks.cordaupdates.app.member.CordappVersionInfo
import net.corda.businessnetworks.cordaupdates.app.member.ReportCordappVersionFlow
...
class ReportCordappVersionFlowTest {
    ...
    fun setup() {
        mockNetwork = MockNetwork(cordappPackages = listOf(
                "net.corda.businessnetworks.cordaupdates.app.member",
                "net.corda.businessnetworks.cordaupdates.app.bno",
                "net.corda.businessnetworks.cordaupdates.transport.flows"),
